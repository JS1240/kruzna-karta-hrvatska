#!/usr/bin/env python3
"""Test script for VisitRijeka.hr scraper."""
...
@pytest.mark.asyncio
async def test_visitrijeka_scraper():
    """Basic test for the VisitRijeka scraper."""
    print("=" * 60)
    print("VisitRijeka.hr Scraper Test")
    print("=" * 60)

    scraper = VisitRijekaScraper()

    try:
        print("Starting VisitRijeka scraper test (max 1 page)...")
        ...
        filename = f"visitrijeka_scraper_test_{timestamp}.json"
...
if __name__ == "__main__":
    success = asyncio.run(test_visitrijeka_scraper())
