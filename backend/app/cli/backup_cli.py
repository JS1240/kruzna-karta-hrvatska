...
def main():
    ...
    parser_full.add_argument('--no-analytics', action='store_false', dest='include_analytics',
    ...
    parser_restore.add_argument('--drop-existing', action='store_true',
                               help='Drop existing database connections before restore')
    parser_restore.add_argument('-y', '--yes', action='store_true',
    ...
    parser_cleanup.add_argument('-y', '--yes', action='store_true',
                               help='Skip confirmation prompt')
