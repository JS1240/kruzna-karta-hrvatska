...
from ..models.user_schemas import User as UserSchema
from ..models.user_schemas import (
    UserFavoritesList,
)
from ..models.user_schemas import UserProfile as UserProfileSchema
from ..models.user_schemas import (
    UserProfileUpdate,
    UserResponse,
    UserSearchParams,
...
def get_users(
    ...
    return UsersListResponse(
        users=users, total=total, page=page, size=len(users), pages=pages
    )
...
def get_my_favorites(
    ...
    query = (
        db.query(Event)
        .join(user_favorites, Event.id == user_favorites.c.event_id)
    ...
    favorites = (
        query.order_by(user_favorites.c.created_at.desc())
        .offset(skip)
        .limit(size)
        .all()
    )

    return UserFavoritesList(favorites=favorites, total=total)
