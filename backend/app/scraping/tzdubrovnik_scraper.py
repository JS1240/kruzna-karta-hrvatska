"""TzDubrovnik.hr events scraper with Bright Data support."""
...
BASE_URL = "https://kalendar.dubrovnik.hr"
EVENTS_URL = f"{BASE_URL}/?lang=en"
            ...
            if m:
                try:
                    if pattern.startswith("("):
                        ...
                        month_num = DubrovnikTransformer.CRO_MONTHS.get(month.lower())
                        if month_num:
...
class DubrovnikScraper:
    """High level scraper for Dubrovnik events."""
