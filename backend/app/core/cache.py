...
class CacheService:
    ...
    def _encode_helper(self, obj: Any) -> Any:
        """Helper to encode complex objects for msgpack."""
    ...
    def _decode_helper(self, obj: Any) -> Any:
        """Helper to decode complex objects from msgpack."""
    ...
    def _serialize_value(self, value: Any) -> bytes:
        """Serialize value for storage using msgpack."""
        try:
            return msgpack.packb(value, default=self._encode_helper, use_bin_type=True)
        except Exception as e:
            logger.error(f"Serialization error: {e}")
            return msgpack.packb(str(value), use_bin_type=True)

    def _deserialize_value(self, value: bytes) -> Any:
        """Deserialize value from storage."""
        try:
            return msgpack.unpackb(value, object_hook=self._decode_helper, raw=False)
        except Exception:
            try:
