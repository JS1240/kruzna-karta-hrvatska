  ...
  const regions = [
    {
      ...
      name: "Dalmatia",
      description:
        "Known for its stunning coastline with crystal-clear waters, historic cities like Split and Dubrovnik, and beautiful islands. Dalmatia offers a perfect blend of history, culture, and natural beauty.",
      attractions: [
    ...
    },
    {
      ...
      name: "Istria",
      description:
        "Croatia's heart-shaped peninsula known for its rolling hills, medieval hilltop towns, truffles, and excellent wines. Istria showcases a unique blend of Croatian and Italian influences.",
      attractions: [
        "Pula Arena",
        "Rovinj Old Town",
        "Motovun",
    ...
    },
    {
      ...
      name: "Zagreb Region",
      description:
        "The capital region offers a mix of Austro-Hungarian architecture, vibrant cultural scene, and charming streets. Zagreb itself is known for its museums, cafes, and historic Upper Town.",
      attractions: [
        "St. Mark's Church",
        "Dolac Market",
    ...
    },
    {
      ...
      name: "Slavonia",
      description:
        "The eastern region of Croatia known for its plains, oak forests, vineyards, and rich folk traditions. Slavonia offers authentic cultural experiences away from tourist crowds.",
      attractions: [
    ...
    },
    {
      ...
      name: "Kvarner",
      description:
        "A coastal region with beautiful islands, historic resorts, and the port city of Rijeka. The area combines mountains meeting the sea with Habsburg-era architecture.",
      attractions: [
        "Opatija Riviera",
        "Island of Krk",
        "Učka Nature Park",
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="md:w-1/3">
            ...
            <p className="font-josefin">
              ...
              discover what makes Croatia one of Europe's most captivating
              destinations.
            </p>
          </div>
