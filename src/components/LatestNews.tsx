...
const LatestNews = () => {
  const news = [
    ...
    },
    {
      ...
      date: "20/06/2025",
      description: "Coastal wellness retreats see surge in bookings for summer season.",
    ...
    },
    {
      ...
      date: "18/06/2025",
      description: "New business meetups scheduled across major Croatian cities.",
  ...
  return (
    <section className="mb-12 bg-white rounded-lg shadow-lg p-6 border border-light-blue">
      <h2 className="text-2xl font-bold mb-6 font-sreda text-navy-blue">Latest News</h2>
      ...
      >
        <CarouselContent className="-ml-2 md:-ml-4">
          {news.map((item) => (
            <CarouselItem key={item.id} className="pl-2 md:pl-4 basis-full sm:basis-1/2 md:basis-1/3 lg:basis-1/3">
