...
const EventCard: React.FC<EventCardProps> = ({ id, title, image, date, location }) => {
  ...
  return (
    ...
    >
      ...
      />
      <div className="font-bold text-lg text-navy-blue mb-1 text-center truncate w-full">{title}</div>
