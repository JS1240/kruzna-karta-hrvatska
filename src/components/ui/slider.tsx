...
const Slider = React.forwardRef<
  ...
  SliderProps
>(({ className, showInput = false, onInputChange, min = 0, max = 100, step = 1, value, inputClassName, ...props }, ref) => {
  ...
  const handleInputBlur = () => {
    ...
    if (isNaN(numValue)) {
      ...
      const currentValue = Array.isArray(value) ? value[0] : (value as number || min);
